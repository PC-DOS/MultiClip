...
.Interval = 1
End With
For a = 0 To Form1.List1.ListCount
List1.List(a) = Form1.List1.List(a)
Next a
HWND_TOPMOST = -1
SWP_NOSIZE = &H1
SWP_NOREDRAW = &H8
...
Select Case Check1.Value
Case 1
SetWindowPos Form2.hwnd, HWND_TOPMOST, 0, 0, Me.Width, Me.Height, SWP_NOMOVE Or SWP_NOSIZE
If 25 = 245 Then
Me.Height = 8190
Me.Width = 11460
End If
Case 0
SetWindowPos Form2.hwnd, HWND_NOTOPMOST, 0, 0, Me.Width, Me.Height, SWP_NOMOVE Or SWP_NOSIZE
If 25 = 245 Then
Me.Height = 8190
Me.Width = 11460
End If
